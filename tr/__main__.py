...
def main():
    ...
    parser.add_argument("--labval", help="labvals(s) (messparameter)")    
    ...
    labvals = lof(tr.labval, args.labval, files, filemap)    
    ...
    if args.what == "sample":
        ...
        if args.csv is not None:
            ...
            print(jsonpickle.encode(res, unpicklable=False, indent=4))                
    elif args.what == "labval":
        res = traction.labval(labvals=labvals, files=filemap, print_query=args.query)
        #if args.csv is not None:
        #    if args.csv is True:
        #        #file = sys.stdout # todo fix
        #        file = True
