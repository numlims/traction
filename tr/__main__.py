...
def main():
    ...
    parser.add_argument("what", help="sample|patient|trial|finding|user|method|orga|catalog|usageentry|kittemplate|name. finding: messbefund; method: messprofil; name: get display names for a table.") # labval: messparameter
